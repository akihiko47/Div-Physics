function drawParticles(particles) {
    for (let particle of particles) {
        if (particle.radius) {
            particle.domElement.style.width = particle.radius * 2 + "px";
            particle.domElement.style.height = particle.radius * 2 + "px";
            particle.domElement.style.left = particle.x_now - particle.radius + "px";
            particle.domElement.style.top = particle.y_now - particle.radius + "px";
